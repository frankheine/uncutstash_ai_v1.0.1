    ...
    initPromise = (async () => {
        try {
            ...
            try {
                ...
                console.warn(`WebGPU request failed: ${error.message}. Initializing CPU fallback.`);
                gpuAvailable = false;
            }
            ...
            if (gpuAvailable) {
                try {
                    ...
                    try {
                        ...
                        await caches.delete("uncutstash-ai-models-v1");
                    } catch (e) {
                    ...
                    // [RESTORED]: Exact HuggingFace /resolve/main/ pathing
