    ...
    >
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          ...
          <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer bg-transparent sticky bottom-0 mt-auto flex flex-col gap-4 overflow-visible rounded-t-(--composer-radius) pb-4 md:pb-6">
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-white/10 backdrop-blur-md border border-white/10 shadow-lg text-foreground rounded-2xl px-4 py-2.5 wrap-break-word empty:hidden">
