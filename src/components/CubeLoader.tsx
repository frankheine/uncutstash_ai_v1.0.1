...
export const CubeLoader = () => {
  ...
  useEffect(() => {
    ...
    // Variant specifics removed. Only rendering core cube.
    ...
    // We use GSAP for specific snappy physics
  ...
  return <div ref={mountRef} className="relative w-48 h-48 mb-8 flex items-center justify-center filter drop-shadow-[0_0_15px_rgba(139,92,246,0.6)]" />;
};
